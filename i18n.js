...
(function () {
  var MESSAGES = {
    ...
    /* ─── Sidebar ─── */
    "sidebar.newChat":          { ja: "新規チャット",     en: "New Chat" },
    "sidebar.section.agents":   { ja: "楽天AIエージェント", en: "Rakuten AI Agents" },
    "nav.rakutenAI":            { ja: "Rakuten AI",      en: "Rakuten AI" },
    "nav.shopping":             { ja: "楽天市場",         en: "Rakuten Ichiba" },
    "nav.travel":               { ja: "楽天トラベル",     en: "Rakuten Travel" },
    "nav.music":                { ja: "楽天ミュージック",  en: "Rakuten Music" },
    "nav.mobile":               { ja: "楽天モバイル",     en: "Rakuten Mobile" },
    "sidebar.section.essentials":{ ja: "便利ツール",      en: "Useful Tools" },
    "nav.aiSearch":             { ja: "検索",            en: "Search" },
    "nav.imageCreator":         { ja: "画像を作る",      en: "Image Creator" },
    "nav.videoCreator":         { ja: "動画を作る",      en: "Video Creator" },
    "nav.voiceJournal":         { ja: "会話メモ",        en: "Voice Journal" },
    "nav.aiTranslator":         { ja: "翻訳",            en: "Translator" },
    "nav.problemSolver":        { ja: "問題を解く",      en: "Problem Solver" },
    "sidebar.showMore":         { ja: "もっと見る",      en: "Show more" },
    "sidebar.community":        { ja: "AI コミュニティー", en: "AI Community" },
    "sidebar.enter":            { ja: "入る ›",          en: "Enter ›" },
    "sidebar.favorites":        { ja: "お気に入り",      en: "Favorites" },
    "sidebar.chatHistory":      { ja: "チャット履歴",    en: "Chat history" },
    "sidebar.seeAll":           { ja: "すべて表示 ›",    en: "See all ›" },
    ...
    /* ─── Home ─── */
    "home.greeting":            { ja: "何かお手伝いできるところありますか", en: "Hi, how can I help you?" },
    "composer.placeholder":     { ja: "質問してみる",     en: "Ask a question" },
    "composer.thinkDeeper":     { ja: "高速応答",        en: "Fast Response" },
    "composer.connectors":      { ja: "コネクター",      en: "Connectors" },

    /* ─── Quick pills ─── */
    "pill.aiSearch":            { ja: "検索",            en: "Search" },
    "pill.imageCreator":        { ja: "画像を作る",      en: "Image Creator" },
    "pill.videoCreator":        { ja: "動画を作る",      en: "Video Creator" },
    "pill.voiceJournal":        { ja: "会話メモ",        en: "Voice Journal" },
    "pill.aiTranslator":        { ja: "翻訳",            en: "Translator" },
    "pill.problemSolver":       { ja: "問題を解く",      en: "Problem Solver" },
    "pill.aiSummarizer":        { ja: "要約",            en: "Summarizer" },
    "pill.writingAssistant":    { ja: "文章を書く",      en: "Writing Assistant" },
    "pill.codingAssistant":     { ja: "コーディング支援",  en: "Coding Assistant" },
    ...
    "footer.disclaimer":        { ja: "生成AIの回答・説明は不正確な場合があります。回答内容については必ずご自身で確認してください。なお、このツールの利用規約は", en: "Generative AI responses may be inaccurate. Please verify answers yourself. Terms of service for this tool can be found" },
    "footer.precautions":       { ja: "こちら",          en: "here" },
    "footer.disclaimerSuffix":  { ja: "をご確認ください。", en: "." },
    "footer.hide":              { ja: "非表示",          en: "Hide" },
    "footer.vjDisclaimer":      { ja: "生成AIの回答・説明は不正確な場合があります。回答内容については必ずご自身で確認してください。なお、このツールの利用規約は", en: "Generative AI responses and explanations may be inaccurate. Please be sure to check the answer by yourself. You can find the terms of service for this tool" },
